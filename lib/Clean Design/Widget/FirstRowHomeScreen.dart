...
class FirstRow extends StatefulWidget {
  const FirstRow({Key? key, required this.imgPath1, required this.imgPath2, required this.avatarImg, required this.nameItem, required this.nameUser, required this.time}) : super(key: key);
